...
We can see that:
cluster 1 has high betweenness centrality but low in all other values ==> These are probably transhipment nodes
Cluster 3 has median betweenness centrality value as well as degree centrality value ==> These are probably whole seller
Cluster 2 may need further breakdown as some of them are high in eigen value, some are high in in degree centrality, some are high in out degree centrality.We will make some inference based on the connectivity
